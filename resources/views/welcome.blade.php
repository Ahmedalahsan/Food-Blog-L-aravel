			...
			<div class="row">
				<div class="col-lg-6">
					<article class="hentry post post-standard has-post-thumbnail sticky">
						...
						<div class="post-thumb">
							<img src="{{$secend_post->featured}}" alt="seo">
							<div class="overlay"></div>
							<a href="{{$secend_post->featured}}" class="link-image js-zoom-image">
								<i class="seoicon-zoom"></i>
							</a>
							<a href="#" class="link-post">
								<i class="seoicon-link-bold"></i>
						...
						<div class="post__content">
							...
							<div class="post__content-info">
								...
								<h2 class="post__title entry-title ">
									<a href="{{route('post.single',['slug'=>$secend_post->slug])}}">{{$secend_post->title}}</a>
								</h2>
								...
								<div class="post-additional-info">
									...
									<span class="post__date">
										...
										<time class="published" datetime="2016-04-17 12:00:00">
											{{$secend_post->created_at->diffForHumans()}}
										</time>
									...
									<span class="category">
										<i class="seoicon-tags"></i>
										<a href="{{route('category.single',['id'=> $secend_post->category->id])}}">{{$secend_post->category->name}}</a>
									</span>
				...
				<div class="col-lg-6">
					<article class="hentry post post-standard has-post-thumbnail sticky">
						...
						<div class="post-thumb">
							<img src="{{$thired_post->featured}}" alt="seo">
							<div class="overlay"></div>
							<a href="{{$thired_post->featured}}" class="link-image js-zoom-image">
								<i class="seoicon-zoom"></i>
							</a>
							<a href="#" class="link-post">
								<i class="seoicon-link-bold"></i>
						...
						<div class="post__content">
							...
							<div class="post__content-info">
								...
								<h2 class="post__title entry-title ">
									<a href="{{route('post.single',['slug'=> $thired_post->slug])}}">{{$thired_post->title}}</a>
								</h2>
								...
								<div class="post-additional-info">
									...
									<span class="post__date">
										...
										<time class="published" datetime="2016-04-17 12:00:00">
											{{$thired_post->created_at->diffForHumans()}}
										</time>
									...
									<span class="category">
										<i class="seoicon-tags"></i>
										<a href="{{route('category.single',['id'=> $thired_post->category->id])}}">{{$thired_post->category->name}}</a>
									</span>
					...
					<div class="col-lg-12">
								...
								<div class="case-item-wrap">
									...
									<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
										<div class="case-item">
											...
											<h6 class="case-item__title text-center"><a href="{{route('post.single',['slug'=> $post->slug])}}">
													{{$post->title}}
												</a></h6>
										</div>
									</div>
						...
						<div class="offers">
							<div class="row">
								<div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
									<div class="heading">
										<h4 class="h1 heading-title">{{$ruby->name}}</h4>
										<div class="heading-line">
											<span class="short-line"></span>
											<span class="long-line"></span>
										</div>
							...
							<div class="row">
								<div class="case-item-wrap">
									@foreach($ruby->posts()->take(3)->get() as $post)
